...
const Login = () => {
  return (
    <section className="text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-50">
      <div className="container 2xl:px-100 lg:px-80 px-5 lg:py-36 py-10 place-content-evenly mx-auto flex flex-wrap items-center min-h-screen">
        <div className="w-full pr-0 xl:mb-4 lg:mb-3 md:mb-2">
          ...
          <p className="leading-relaxed mt-4 lg:text-2xl text-xl font-medium text-black dark:text-gray-50 text-center">
            Check your household needs and manage them is easier than ever
          </p>
        </div>
        <div className="bg-gray-200 dark:bg-gray-500 shadow-inner rounded-lg p-8 lg:py-10 py-20 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
